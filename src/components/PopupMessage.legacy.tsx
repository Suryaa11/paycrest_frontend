...
function sanitizeText(s: string) {
  ...
  // remove parenthesized urls like (http://...)
  t = t.replace(/\s*\(https?:\/\/[^)]+\)/g, '');
  // remove status prefixes like '400 Bad Request:'
...
function guessFocusSelector(text: string): string | null {
  ...
  if (t.includes('m-pin') || t.includes('mpin') || t.includes('pin')) return 'input[type="password"][maxLength="4"], input[name*="mpin"]';
